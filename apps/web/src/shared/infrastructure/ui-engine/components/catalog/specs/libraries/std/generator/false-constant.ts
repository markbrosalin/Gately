...
export const FALSE_CONSTANT_GENERATOR_ICON_PATH =
...
export const FALSE_CONSTANT_GENERATOR_ITEM: CatalogLogicItem = {
    ref: {
        libraryId: "std",
        path: ["generator"],
    ...
    meta: {
        name: "False Constant",
        description: "Continuously outputs a constant false signal.",
        tags: ["false", "const", "0", "generator"],
        createdAt: 0,
        extensions: {
            i18nKey: "catalog.std.generator.false_constant",
        },
    },
    layout: {
        width: 32,
        ...
        },
        {
            ...
            config: {
                base: {
                    attrs: {
                        icon: {
                            d: FALSE_CONSTANT_GENERATOR_ICON_PATH,
