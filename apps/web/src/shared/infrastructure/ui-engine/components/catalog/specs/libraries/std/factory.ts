...
export const mkStdLogicItemMarkup = (
    props: {
...
export const mkStdLogicItemPorts = (): Metadata => ({
    items: [],
    groups: {
        left: {
...
export const mkStdLogicItemAttrs = (options: BaseNodeAttrsOptions) => {
    return {
        body: {
            x: NODE_INSET,
            y: NODE_INSET,
